...
public class PlaylistController {
    ...
    @FXML
    public Button delete_Playlist_btn;
    @FXML
    public Label lbl_empty;
    @FXML
    public Label lbl_notesist;
    ...
    public void add_Playlist(ActionEvent actionEvent) {

        //Enter the name of the playlist - Label lbl_empty message
